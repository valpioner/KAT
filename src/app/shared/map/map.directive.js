(function () {
    ...
    function map() {
        ...
        function mapCtrl($scope/*, uiGmapGoogleMapApi, NgMap*/, $timeout) {
            ...
            //var map = angular.element('#appBusyIndicator');
            ...
            function initialize (map) {                                
                ...
                var mapOptions = {
                    zoom: 3,
                    center: new google.maps.LatLng(10, 25),
                ...
                var poly_flights = {
                    kat0_1: new google.maps.Polyline(poly_flights_options).setPath([ll.kiew, ll.ams, ll.ny, ll.minneapolis, ll.anchorage, ll.sf]),
                    kat0_2: new google.maps.Polyline(poly_flights_options).setPath([ll.la, ll.ny, ll.paris, ll.kiew]),
                    kat1_1: new google.maps.Polyline(poly_flights_options).setPath([ll.krakow, ll.oslo, ll.venice]),
                    kat1_2: new google.maps.Polyline(poly_flights_options).setPath([ll.hcm, ll.bkk, ll.istanbul, ll.kiew]),
                }

                //poly_ground
                var poly_ground_options = {
                    strokeColor: '#FF6300',
                    strokeOpacity: 1.0,
                    strokeWeight: 2,
                    map: map
                ...
                //    var path = poly_test_options.getPath();
                //    path.push(event.latLng);
                //    //console.log(event.latLng);


                //    str += "new google.maps.LatLng(" + event.latLng.A + ", " + event.latLng.F + "), ";
                //    console.log(str);
                ...
                // markers
                var markers = {
                    lviv: new google.maps.Marker({
                        position: new google.maps.LatLng(49.839683, 24.029717),
                        map: map,
                        title: 'I am here',
                        animation: 2
                    })
